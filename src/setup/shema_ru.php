...
перейдите в <a href='/bos/#app=uprofile/wspace/ws/'>профиль пользователя</a>
для редактирования.</p>

<h4>Базовые настройки сайта</h4>
<p>
<a href='/bos/#app=bos/wspace/ws/'>Панель управления</a>
...
<p>
	...
	<a href='http://abricos.org/forum/' title='Форум'>Форум по платформе Абрикос</a><br />
</p>
	";

    $about = "
		<h2>О проекте</h2>
		<p><a href='http://abricos.org'>Абрикос</a> - это современная система управления web-контентом (CMS) и платформа интернет приложений.</p>
	";
